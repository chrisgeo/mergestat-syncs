...
def test_github_private_repo():
    ...
    try:
        ...
        if not found:
            ...
            print(f"   This might mean the token doesn't have access to this repository")
        ...
        if "404" in str(e):
            ...
            print(f"   Either the repository doesn't exist or your token doesn't have access")
        else:
            print(f"\n❌ API error: {e}")
        return False
...
def test_gitlab_private_project():
    ...
    try:
        ...
        print(f"\n❌ Authentication failed: {e}")
        print("   Make sure your GITLAB_TOKEN has 'read_api' and 'read_repository' scopes")
        return False
        
    except APIException as e:
        if "404" in str(e):
            print(f"\n❌ Project not found: {e}")
            print(f"   Either the project doesn't exist or your token doesn't have access")
        else:
            print(f"\n❌ API error: {e}")
        return False
